...
!!! info "Status: Live (reproduced 2026-05-23)"
    Historical release-planning document for v0.5.0. The authoritative release record is the [GitHub Releases page](https://github.com/ExamonHPC/examon/releases).
